    ...
    public partial class Form1 : Form
    {
            ...
            try
            {
                ...
                foreach (XmlNode xnode in new_elem)
                {
                    ...
                    if (xnode.Name == "Hard_leaf")
                    {
                        foreach (XmlNode childnode_of_child_0 in xnode.ChildNodes)
                        {
                            if (childnode_of_child_0.Name == "Channel_price")
                                textBox12.Text = $"{childnode_of_child_0.InnerText}";
                            if (childnode_of_child_0.Name == "Cover_price")
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (flag != 1)
            {
                ...
                form2.channel_cost = this.textBox12;
                form2.cover_cost = this.textBox13;
                form2.ShowDialog();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (flag == 0)
            {
                ...
                XmlElement Channel_price = new_doc.CreateElement("Channel_price");
                XmlText Channel_price_text = new_doc.CreateTextNode(textBox12.Text);
                Channel_price.AppendChild(Channel_price_text);
                Hard_leaf.AppendChild(Channel_price);

                XmlElement Cover_price = new_doc.CreateElement("Cover_price");
                XmlText Cover_price_text = new_doc.CreateTextNode(textBox13.Text);
                Cover_price.AppendChild(Cover_price_text);
                Hard_leaf.AppendChild(Cover_price);
