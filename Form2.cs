...
namespace Создатель_расчетов
{
    public partial class Form2 : Form
    {
        ...
        public TextBox cover_costA3;
        public TextBox channel_costA3;
        public TextBox cover_costA4;
        public TextBox channel_costA4;
        public TextBox cover_costA5;
        public TextBox channel_costA5;
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                for (int i = 0; i < app_table.Rows.Count; i++)
                {
                    ...
                    {
                        temp_channel_cost = product_count * Double.Parse(channel_costA3.Text);
                        temp_cover_cost = product_count * Double.Parse(cover_costA3.Text);
                        hard_leaf = temp_cover_cost + temp_channel_cost;
                    }
                    if (app_table.Rows[i][8].ToString() == "2")
                    {
                        temp_channel_cost = product_count * Double.Parse(channel_costA4.Text);
                        temp_cover_cost = product_count * Double.Parse(cover_costA4.Text);
                        hard_leaf = temp_cover_cost + temp_channel_cost;
                    }
                    if (app_table.Rows[i][8].ToString() == "3")
                    {
                        temp_channel_cost = product_count * Double.Parse(channel_costA5.Text);
                        temp_cover_cost = product_count * Double.Parse(cover_costA5.Text);
                        hard_leaf = temp_cover_cost + temp_channel_cost;
                    }
            ...
            dataGridView1.Rows[3].Cells[columns_count - 5].Value = "В зависимости от формата";
            dataGridView1.Rows[4].Cells[columns_count - 4].Value = "Стоимость канала";
            dataGridView1.Rows[3].Cells[columns_count - 4].Value = "В зависимости от формата";
            ...
            for(int i = 0; i < app_table.Rows.Count; i++)
            {
                ...
                if(app_table.Rows[i][8].ToString() == "1")
                {
                    dataGridView1.Rows[i + 5].Cells[columns_count - 4].Value = temp_product_count * Double.Parse(channel_costA3.Text);
                    dataGridView1.Rows[i + 5].Cells[columns_count - 5].Value = temp_product_count * Double.Parse(cover_costA3.Text);
                }
                if (app_table.Rows[i][8].ToString() == "2")
                {
                    dataGridView1.Rows[i + 5].Cells[columns_count - 4].Value = temp_product_count * Double.Parse(channel_costA4.Text);
                    dataGridView1.Rows[i + 5].Cells[columns_count - 5].Value = temp_product_count * Double.Parse(cover_costA4.Text);
                }
                if (app_table.Rows[i][8].ToString() == "3")
                {
                    dataGridView1.Rows[i + 5].Cells[columns_count - 4].Value = temp_product_count * Double.Parse(channel_costA5.Text);
                    dataGridView1.Rows[i + 5].Cells[columns_count - 5].Value = temp_product_count * Double.Parse(cover_costA5.Text);
                }
            }
        }
